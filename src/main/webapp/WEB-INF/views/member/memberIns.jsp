...
<html lang="utf-8">
    ...
    <body >
	   ...
	   <div class="p-2 mb-3 text-dark text-center fw-bold fs-3" >회원 등록</div>
				  ...
				  <div class="row g-2 ">
				   <div class="col-md">
				    <div class="input-group mb-3">
					  ...
					  <input type="text" class="form-control" aria-label="userNm" name="userNm"  id="userNm" aria-describedby="basic-addon1">
					</div>
				  </div>
				  <div class="col-md">
				    <div class="input-group mb-3">
					  <span class="input-group-text" id="basic-addon1">전화번호</span>
					  <input type="text" class="form-control" aria-label="mobile" name="mobile" id="mobile" aria-describedby="basic-addon1">
					</div>
				  </div>
				</div>
				  <div class="row g-2">
		...
		<div class="d-grid gap-2 col-1 mx-auto">
	      <button type="button" class="btn btn-darkgray"  onclick="createMember();">등록</button>
	    </div>
